...
const SelectRole = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center w-full h-full font-poppins bg-white md:flex-row md:items-start lg:justify-between lg:w-full'>
          ...
          {/* BUYER */}
          {
            role === 'buyer' && count === 8 && <div className='absolute h-screen w-full bg-[#dddddd] opacity-50'></div>
          }
          {
          ...
          {/* SUPPLIER */}
          {
            role === 'supplier' && count === 7 && <div className='absolute h-screen w-full bg-[#dddddd] opacity-50'></div>
          }
          {
            role === 'supplier' && count === 7 && <SellerSuccessfulModal />
          }
