...
const SellersDetailsTable = ({customerDetails}) => {

      const requests = customerDetails.supply_request.data
  ...
  return (
    <div className='relative flex flex-col items-center justify-start w-full h-[29.5rem] border-[1px] border-[#dddddd] rounded-lg mt-3 mb-12 py-2 pb-5 md:h-[27.5rem] 
             ...
             <tr tr className='w-full mb-1'>
                 ...
                 <td className='text-[10px] text-[#667085] xl:text-[11px]'>Ore Type</td>
                 <td className='text-[10px] text-[#667085] xl:text-[11px]'>Amount</td>
             ...
             <tbody className='w-full'>
                  ...
                  <tr key={item.id} className='h-14'>
                      ...
                      <td class="border-b text-[9px] font-medium">{item.amount} </td>
...
export default SellersDetailsTable
