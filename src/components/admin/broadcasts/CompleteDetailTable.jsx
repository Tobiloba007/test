    ...
    <div className='relative flex flex-col items-center justify-start w-full h-[29.5rem] border-[1px] border-[#dddddd] rounded-lg mt-3 mb-12 py-2 pb-5 md:h-[27.5rem] 
             ...
             <tbody className='w-full'>
                  <tr className='h-14'>
                      ...
                      <td class="flex items-center justify-start h-14 border-b text-[10px] font-medium pr-14 md:pr-5 xl:pr-28">Majet Pryanshu</td>

                      <td class="border-b text-[10px] font-medium pr-2 xl:pr-5">
                      ...
                      <td class="border-b text-[10px] font-medium">
                          <div className='flex items-center justify-start'>
                             <p className=''>MajetPryanshu@gmail.com</p>
                             <MdOutlineFileCopy className='text-[#D0D5DD] ml-2 text-xs' />
                          </div>
                      </td>

                      <td class="border-b text-[10px] font-medium xl:pr-4">Abuja, Nigeria</td>

                      <td class="border-b text-[10px] font-medium xl:pr-4">5,999</td>
                      
                      <td class="border-b text-[10px] font-medium">$ 222.23</td>
...
export default CompleteDetailTable
