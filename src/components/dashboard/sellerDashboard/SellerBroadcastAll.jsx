...
import { getBroadcasts, searchBroadcastList } from "../../../features/buyer/BuyerActions";





const SellerBroadcastAll = ({setBroadcastDetails}) => {
...
export default SellerBroadcastAll
